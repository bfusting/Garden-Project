...
public class ChooseTemplate extends Screen {
	...
	public ChooseTemplate(Controller c,Stage s) {
		...
		hoverBG = new Background(new BackgroundImage(new Image("v850-sasi-13copy.jpg"),BackgroundRepeat.NO_REPEAT,BackgroundRepeat.NO_REPEAT,BackgroundPosition.CENTER,BackgroundSize.DEFAULT));
